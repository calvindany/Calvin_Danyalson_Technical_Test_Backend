...
import { bigint, int, boolean, mysqlTable, serial, text, uniqueIndex, varchar, datetime, mysqlEnum } from "drizzle-orm/mysql-core";
...
export const Leads = mysqlTable("tr_leads", {
    ...
    excluded_sales_person: text("excluded_sales_person").notNull(),
    created_by: int("created_by").notNull(),
    created_at: datetime("created_at").default(sql`now()`),
})
